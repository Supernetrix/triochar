---
title: Artisan Biochar Explained
slug: artisan-biochar-explained
summary: >-
  In this video, Triochar founder Kubi introduces Artisan Biochar, a program
  powered by Carbon Standards International that enables farmers to generate
  extra income by producing artisan biochar from agricultural residues. It walks
  through the step-by-step kiln burning process, local soil application rules,
  and how farmers use a simple dMRV mobile app to track production and receive
  fair carbon credit payments.
date: '2026-05-16'
